 ...
 *  获取排序和原始的数组
 */
typedef void(^AllAddressBookArrayBlock)(NSArray<PPPersonModel *> *addressBookArray,NSDictionary<NSString *,NSArray *> *addressBookDict,NSArray *nameKeys);
 ...
 *  获取按A~Z顺序排列的所有联系人
 *
 *  @param addressBookInfo 装着排序和未排序的数组block
 *  @param failure         授权失败的Block
 */
